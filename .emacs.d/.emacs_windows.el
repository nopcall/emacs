...
;; 根据 customize-groups或者customize-variables定义的
;; Magic! Don'T Touch!
(custom-set-variables
 ...
 '(ac-dictionary-directories (quote ("~/.emacs.d/auto-complete-1.3.1/dict")))
 '(ac-user-dictionary-files (quote ("~/.emacs.d/auto-complete-1.3.1/dict")))
...
(custom-set-faces
 ...
 '(region ((t (:background "yellow" :foreground "dark slate gray"))))
